                ...
                <form enctype="multipart/form-data" method="post" action="{{route('dish-update', $dish)}}">
                    <div class="form-row d-flex">
                        ...
                        <div class="col-md-5">
                            ...
                            <select class="form-control" name="menu_id" value="{{$dish->manu_id}}">
                    ...
                    <div class="form-row">
                        <div class="col-md-">
                            ...
                            <textarea required id="desciption" type="number" class="form-control" name="description" cols="50" rows="4">{{$dish->description}}</textarea>
                        </div>
                    </div>
                    <div class="form-row">
